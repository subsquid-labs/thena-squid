module.exports = class Data1682182574402 {
    name = 'Data1682182574402'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "pool" ("id" character varying NOT NULL, "factory" text NOT NULL, "token0" text NOT NULL, "token1" text NOT NULL, CONSTRAINT "PK_db1bfe411e1516c01120b85f8fe" PRIMARY KEY ("id"))`)
