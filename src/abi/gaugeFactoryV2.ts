...
import {ABI_JSON} from './gaugeFactoryV2.abi'
...
export const functions = {
    ...
    createGaugeV2: new Func<[_rewardToken: string, _ve: string, _token: string, _distribution: string, _internal_bribe: string, _external_bribe: string, _isPair: boolean], {_rewardToken: string, _ve: string, _token: string, _distribution: string, _internal_bribe: string, _external_bribe: string, _isPair: boolean}, string>(
        abi, '0x7379e770'
    ),
    gauges: new Func<[], {}, Array<string>>(
        abi, '0x821bdcf1'
    ),
    initialize: new Func<[_permissionRegistry: string], {_permissionRegistry: string}, []>(
        abi, '0xc4d66de8'
    ),
