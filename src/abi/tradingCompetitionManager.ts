...
export const functions = {
    ...
    allowedTokenForPrize: new Func<[_: bigint], {}, string>(
        abi, '0xc7e89c48'
    ),
...
export class Contract extends ContractBase {
    ...
    allowedTokenForPrize(arg0: bigint): Promise<string> {
        return this.eth_call(functions.allowedTokenForPrize, [arg0])
    }
