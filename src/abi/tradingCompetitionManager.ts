...
export const functions = {
    ...
    create: new Func<[_tradingCompetition: ([entryFee: bigint, MAX_PARTICIPANTS: bigint, owner: string, tradingCompetition: string, name: string, description: string, timestamp: ([startTimestamp: bigint, endTimestamp: bigint, registrationStart: bigint, registrationEnd: bigint] & {startTimestamp: bigint, endTimestamp: bigint, registrationStart: bigint, registrationEnd: bigint}), market: number, prize: ([win_type: boolean, weights: Array<bigint>, totalPrize: bigint, owner_fee: bigint, token: string] & {win_type: boolean, weights: Array<bigint>, totalPrize: bigint, owner_fee: bigint, token: string}), competitionRules: ([starting_balance: bigint, winning_token: string, tradingTokens: Array<string>] & {starting_balance: bigint, winning_token: string, tradingTokens: Array<string>})] & {entryFee: bigint, MAX_PARTICIPANTS: bigint, owner: string, tradingCompetition: string, name: string, description: string, timestamp: ([startTimestamp: bigint, endTimestamp: bigint, registrationStart: bigint, registrationEnd: bigint] & {startTimestamp: bigint, endTimestamp: bigint, registrationStart: bigint, registrationEnd: bigint}), market: number, prize: ([win_type: boolean, weights: Array<bigint>, totalPrize: bigint, owner_fee: bigint, token: string] & {win_type: boolean, weights: Array<bigint>, totalPrize: bigint, owner_fee: bigint, token: string}), competitionRules: ([starting_balance: bigint, winning_token: string, tradingTokens: Array<string>] & {starting_balance: bigint, winning_token: string, tradingTokens: Array<string>})})], {_tradingCompetition: ([entryFee: bigint, MAX_PARTICIPANTS: bigint, owner: string, tradingCompetition: string, name: string, description: string, timestamp: ([startTimestamp: bigint, endTimestamp: bigint, registrationStart: bigint, registrationEnd: bigint] & {startTimestamp: bigint, endTimestamp: bigint, registrationStart: bigint, registrationEnd: bigint}), market: number, prize: ([win_type: boolean, weights: Array<bigint>, totalPrize: bigint, owner_fee: bigint, token: string] & {win_type: boolean, weights: Array<bigint>, totalPrize: bigint, owner_fee: bigint, token: string}), competitionRules: ([starting_balance: bigint, winning_token: string, tradingTokens: Array<string>] & {starting_balance: bigint, winning_token: string, tradingTokens: Array<string>})] & {entryFee: bigint, MAX_PARTICIPANTS: bigint, owner: string, tradingCompetition: string, name: string, description: string, timestamp: ([startTimestamp: bigint, endTimestamp: bigint, registrationStart: bigint, registrationEnd: bigint] & {startTimestamp: bigint, endTimestamp: bigint, registrationStart: bigint, registrationEnd: bigint}), market: number, prize: ([win_type: boolean, weights: Array<bigint>, totalPrize: bigint, owner_fee: bigint, token: string] & {win_type: boolean, weights: Array<bigint>, totalPrize: bigint, owner_fee: bigint, token: string}), competitionRules: ([starting_balance: bigint, winning_token: string, tradingTokens: Array<string>] & {starting_balance: bigint, winning_token: string, tradingTokens: Array<string>})})}, [_: string, _: bigint]>(
        abi, '0x3bea0f31'
    ),
